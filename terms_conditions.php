  ...
  <section id="termsConditions">
    <div class="sectionWrapper">
      ...
      <p>
        ...
        this website, www.learningsimpl.com (the "Website"), Learning Simpl
        ...
        guidelines referenced below. Learning Simpl reserves the right to
        ...
        Learning Simpl will alert you that changes or revisions have been made
        ...
        revisions. Learning Simpl encourages you to review this Agreement
        ...
        agreement you may have with Learning Simpl for other products or
      ...
      <p>
        ...
        reps or direct Learning Simpl sales reps, while they are calling you,
        ...
        emails and call solicitations Learning Simpl and its designated in
      ...
      <p>
        ...
        via sending your email address to: info@learningsimpl.com.
      </p>
      <p>
        Proprietary Rights. Learning Simpl has proprietary rights and trade
        secrets in the Products. You may not copy, reproduce, resell or
        redistribute any Product manufactured and/or distributed by Learning
        Simpl. Learning Simpl also has rights to all trademarks and trade
      ...
      <p>
        ...
        nutritional and dietary supplements. Learning Simpl does not always
        ...
        Learning Simpl does create the content on this Website, such content
        is protected by intellectual property laws of the India, foreign
        ...
        solely as a convenience to you. Learning Simpl does not endorse the
        contents on any such third-party websites. Learning Simpl is not
      ...
      <p>
        Use of Website; Learning Simpl is not responsible for any damages
      ...
      <p>
        ...
        written authorization from Learning Simpl or the applicable third
      ...
      <p>
        ...
        BASIS. Learning Simpl EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND,
      ...
      <p>
        Learning Simpl ENTIRE LIABILITY, AND YOUR EXCLUSIVE REMEDY, IN LAW, IN
      ...
      <p>
        Learning Simpl WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT,
        ...
        RESULTING FROM (1) THE USE OR THE INABILITY TO USE THE WEBSITE CONTENT
        OR PRODUCTS; (2) THE COST OF PROCURING SUBSTITUTE PRODUCTS OR CONTENT;
        (3) ANY PRODUCTS PURCHASED OR OBTAINED OR TRANSACTIONS ENTERED INTO
      ...
      <p>
        You will release, indemnify, defend and hold harmless Learning Simpl,
        ...
        supplied to Learning Simpl. When Learning Simpl is threatened with
        suit or sued by a third party, Learning Simpl may seek written
        assurances from you concerning your promise to indemnify Learning
        Simpl; your failure to provide such assurances may be considered by
        Learning Simpl to be a material breach of this Agreement. Learning
        Simpl will have the right to participate in any defense by you of a
        third-party claim related to your use of any of the Website content or
        Products, with counsel of Learning Simpl choice at its expense.
        Learning Simpl will reasonably cooperate in any defense by you of a
        third-party claim at your request and expense. You will have sole
        responsibility to defend Learning Simpl against any claim, but you
        must receive Learning Simpl prior written consent regarding any
      ...
      <h3>PRIVACY</h3>
      <p>
        Learning Simpl believes strongly in protecting user privacy and
        providing you with notice of MuscleUP Nutrition 's use of data. Please
        refer to Learning Simpl privacy policy, incorporated by reference
      ...
      <h3>GENERAL</h3>
      <p>
        Force Majeure. Learning Simpl will not be deemed in default hereunder
      ...
      <p>
        Cessation of Operation. Learning Simpl may at any time, in its sole
      ...
      <p>
        ...
        between you and Learning Simpl and supersedes any prior agreements
        pertaining to the subject matter contained herein.
      </p>

      <p>
        Effect of Waiver. The failure of Learning Simpl to exercise or enforce
      ...
      <p>
        Termination. Learning Simpl reserves the right to terminate your
        ...
        use the Website and Learning Simpl may, in its sole discretion and
        without advance notice to you, cancel any outstanding orders for
        Products. If your access to the Website is terminated, Learning Simpl
        ...
        survive indefinitely unless and until Learning Simpl chooses, in its
